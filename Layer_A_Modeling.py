...
class Layer_A_Modeling():
    def __init__(self, setting):
        ...
        self.A = setting.A
        self.A_edges = self.A_layer_config(setting)[0]
        self.AB_edges = self.A_layer_config(setting)[1]
        self.AB_neighbor = self.A_layer_config(setting)[2]
        self.AB_edges_reverse = self.A_layer_config(setting)[3]
    ...
    def A_layer_config(self, setting):
        ...
        return self.A_edges, self.AB_edges, self.AB_neighbor, self.AB_edges_reverse
